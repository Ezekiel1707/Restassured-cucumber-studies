...
public class basics4 {
	...
	{
		String postdata=GenerateStringFromResource(System.getProperty("user.dir") + "\\src\\test\\java\\resources\\XMLdata\\postdata.xml");
		...
		System.out.println((char[]) x.get("PlaceAddResponse.place_id"));
